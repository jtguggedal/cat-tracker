...
/* Modem manager connection states. */
...
/* Function to set the internal connection state of the modem manager. */
...
static int modem_setup(void)
{
	...
	if (IS_ENABLED(CONFIG_MODEM_MGR_AUTO_REQUEST_POWER_SAVING_FEATURES)) {
